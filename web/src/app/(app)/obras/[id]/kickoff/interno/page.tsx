  ...
  return (
    <div className="p-4 md:p-6">
      <div className="mb-4 flex items-center gap-2 text-sm text-ber-gray">
        ...
        <span>/</span>
        <Link href="../kickoff" className="hover:text-ber-carbon">Kickoff</Link>
        <span>/</span>
        <span className="font-medium text-ber-carbon">Interno</span>
      </div>

      <div className="mb-4 flex items-center gap-2 flex-wrap">
        <Rocket size={20} className="text-ber-teal" />
        <h1 className="text-xl font-black text-ber-carbon">Kickoff Interno</h1>
