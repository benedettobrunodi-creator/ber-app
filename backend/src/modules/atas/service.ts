...
const topicoSelect = {
  ...
  responsavelStakeholder: { select: { id: true, nome: true, empresa: true } },
  atualizacoes: {
...
export async function createTopico(obraId: string, input: CreateTopicoInput) {
  ...
  return prisma.obraAtaTopico.create({
    data: {
      ...
      responsavelStakeholderId: input.responsavelStakeholderId ?? null,
      acao: input.acao ?? null,
      confirmado: false, // item novo nasce pendente: fica fixo no fim até confirmar
...
export async function updateTopico(topicoId: string, input: UpdateTopicoInput) {
  return prisma.obraAtaTopico.update({
    ...
    data: {
      ...
      ...(input.responsavelStakeholderId !== undefined && { responsavelStakeholderId: input.responsavelStakeholderId }),
      ...(input.acao !== undefined && { acao: input.acao }),
      ...(input.confirmado !== undefined && { confirmado: input.confirmado }),
