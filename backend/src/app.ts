...
// — Módulo: férias (controle global de férias dos colaboradores) —
app.use('/v1/ferias', ...perm('ferias'), feriasRoutes);
...
// — Módulo: financeiro (DRE editável, multi-ciclo) —
import financeiroRouter from './modules/financeiro/routes';
app.use('/v1/financeiro', ...perm('financeiro'), financeiroRouter);
...
// — Módulo: atas (Ata Corrida — formato planilha) —
import { obraAtasRouter } from './modules/atas/routes';
